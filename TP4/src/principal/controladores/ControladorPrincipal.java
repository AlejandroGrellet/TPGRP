...
//        System.out.println(alumno1.esSuperAdministrador());
        ...
        System.out.println("------------------PUBLICACIONES------------------");
          //PUBLICACION 1
//        Profesor profe = new Profesor(1, "perez", "juan", "444", Cargo.ADG);
//        MiembroEnGrupo mg1=new MiembroEnGrupo(profe,Rol.ADMINISTRADOR ,grupos.get(0));
...
//        Publicacion publicacion1 = new Publicacion("Título 1",fecha1, "Enlace 1","Resumen 1", mg1 , tipos.get(0),idiomas.get(0) , lugares.get(0), palabras1);
        //PUBLICACION 1
